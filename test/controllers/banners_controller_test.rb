...
class BannersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post banners_url, params: { banner: { date: @banner.date, description: @banner.description, image: @banner.image, place: @banner.place, tittle: @banner.tittle } }
    end
  ...
  test "should update banner" do
    patch banner_url(@banner), params: { banner: { date: @banner.date, description: @banner.description, image: @banner.image, place: @banner.place, tittle: @banner.tittle } }
